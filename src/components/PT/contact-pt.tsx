...
export function ContactPT() {
    return (
      <>
      <div className=" mb-14">
        <h2 className="text-4xl pb-4 lg:py-8 xl:pt-0 xl:pb-10 sm:text-5xl lg:text-6xl text-center tracking-wide mx-3 lg:mx-0 lg:px-0 bg-gradient-to-r from-firstColor to-secondColor text-transparent bg-clip-text font-bold text-balance xl:mt-10">Entrar em contato</h2>
      <div className="text-center flex justify-center  lg:mx-32">
        ...
        <div id="tudo" className="lg:mx-0 lg:bg-[#1e1e1e]  lg:rounded-lg flex flex-row justify-between">
          <div className="text-center flex flex-col justify-center lg:mx-0 lg:bg-[#1e1e1e] lg:py-10 lg:rounded-lg lg:w-1/2">
          <p className="text-zinc-200 font-light">Entre em contato pelas redes sociais:</p>
          ...
          <p className="text-zinc-200 font-light mb-4">Ou envie um email:</p>
          <div id="formulario" className="mx-10">
            <form action="https://formsubmit.co/mytkalol@gmail.com" method="POST">
            <div className="sm:flex sm:flex-row">
            <input type="text" name="name" className="form-control p-2.5 rounded-md w-full bg-[#1e1e1e] text-zinc-300 mb-3 border border-zinc-700 sm:mr-3" placeholder="Seu nome" required></input>
            <input type="email" name="email" className="form-control p-2.5 w-full rounded-md bg-[#1e1e1e] text-zinc-300 border border-zinc-700 mb-3" placeholder="Seu email" required></input>
            </div>
            <textarea placeholder="Sua mensagem" className="form-control  p-2.5 w-full rounded-md bg-[#1e1e1e] text-zinc-300 mb-3 border border-zinc-700 " name="message" rows={10} required></textarea>
            <div className="flex justify-end ">
            <div className="bg-gradient-to-tr from-firstColor to-secondColor w-full p-[1px] rounded-md mb-6 lg:mb-0 md:w-fit" >
            <button type="submit" className="p-3 bg-[#1a1a1a] w-full rounded-md text-zinc-100 md:w-fit lg:px-8">Enviar</button>
            </div>
          ...
          <img src={Imagem} alt=""  className=" hidden lg:flex lg:w-1/2 h-[700px]   object-cover rounded-md"/>
        </div>
        </div>
        </div>
        </div>
