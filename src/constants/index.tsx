...
import logobestia from '../assets/images/logos/bestia.svg';
import logo2game from '../assets/images/logos/logo-2game.svg';
...
interface Teams {
  logo: string;
  name: string;
  start: string; // ex.: "2018" ou "2018 - 2019"
  end?: string;  // opcional
}
...
export const teams: Teams[] = [
  { logo: logo9z,          name: "9z",                 start: "2023",          end: "2022" },
  { logo: logoTBS,         name: "TBS",                start: "2023",          end: "2022" },
  { logo: logoCase,        name: "Case eSports",       start: "2024",          end: "2021" },
  { logo: logoC9,          name: "Cloud9",             start: "2024",          end: "2012" },

  { logo: logo100t,        name: "100 Thieves",        start: "2024",          end: "2012" },
    { logo: logobestia,      name: "Bestia",             start: "2023 - 2024",   end: "2015" },
  { logo: logoCleiteam,    name: "Cleiteam",           start: "2023",          end: "2020" },
  { logo: logoCnb,         name: "CNB",                start: "2018 - 2019",   end: "2019" },
    { logo: logoRed,         name: "Red Canids",         start: "2024",          end: "2007" },
  { logo: logoTl,          name: "Team Liquid",        start: "2019",          end: "2006" }, /* <- corrigido */
  { logo: logoCorinthians, name: "Corinthians eSports",start: "2022",          end: "2018" },
  { logo: logoFalkol,      name: "Falkol",             start: "2019",          end: "2017" },
  { logo: logoFla,         name: "Flamengo eSports",   start: "2019",          end: "2016" },
    { logo: logo2game,          name: "2game",            start: "2023 - 2024",   end: "2015" },
  { logo: logoFx,          name: "Team FX",            start: "2023 - 2024",   end: "2015" },

  { logo: logoImperial,    name: "Imperial",           start: "2022",          end: "2014" },
  { logo: logoIntz,        name: "INTZ",               start: "2017",          end: "2013" },
  { logo: logoLevelling,   name: "Levelling",          start: "2024",          end: "2012" },
  { logo: logoLiberty,     name: "Liberty",            start: "2021 - 2024",   end: "2011" },
  { logo: logoLoops,       name: "Loops",              start: "2023 - 2024",   end: "2010" },
  { logo: logoOpk,         name: "OPK",                start: "2019",          end: "2009" },
  { logo: logoPrg,         name: "PRG",                start: "2019",          end: "2008" },

  { logo: logoTropikaos,   name: "TropiKaos",          start: "2022",          end: "2005" },
];
...
export const podcastEN: ArticlesPT[] = [
  ...
  },
  {
    href: "https://www.youtube.com/watch?v=3jJCMwsTD8Q",
    img: thumbpodcastGameArena,
    title: "Vitor Kenji talks about Physiotherapy in Esports and mentions Fallen case",
    authorLogo: "",
    authorName: "GameArena",
  },
  {
